...
index = 0
inputFolder = "input"
destFilePath = "output/TextRange/delete_text_range.docx"
result = api.delete_text_range(filename, paragraph_path, index, folder=inputFolder, dest_file_path=destFilePath)
